...
LOG_DIR=/u01/maint/logs/trans_stats
...
scp -oStrictHostKeyChecking=no -i /u01/maint/scripts/manager_id_rsa /u01/maint/logs/trans_stats/$report_file manager@awsnaiad01.cfcore.net:/opt/vcg/report/drop/live/
