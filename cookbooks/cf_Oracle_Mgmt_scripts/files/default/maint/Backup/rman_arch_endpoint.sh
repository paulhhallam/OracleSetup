...
# Check /u01/maint/logs/rmanlogs/rman_endpoint_arch_backup_yyyy_mm_dd.log for issues.
...
LOG_DIR=/u01/maint/logs/rmanlogs/endpoint
...
if [ "$ERRCOUNT" -ne 0 ]; then
        ...
        echo '*****************************************************************'
        echo 'RMAN- errors detected in log file on ' $HOSTNAME | mail -s "Endpoint RMAN ARCH backup - *** Error ***" -a ${RMANLOG} $MAIL_RECIPIENT
  else
